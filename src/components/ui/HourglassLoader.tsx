...
export function HourglassLoader({ className }: HourglassLoaderProps) {
  return (
    <div className={cn("inline-block", className)} aria-hidden="true">
      <svg
        aria-label="hourglass loader with sand falling animation"
        role="img"
        height="56px"
        width="56px"
        viewBox="0 0 56 56"
        ...
        <g transform="translate(2,2)">
          ...
          >
            <circle
              ...
              cx="26"
              strokeWidth="2.5"
              className="hourglass-loader__motion-thick"
            />
            <circle
              transform="rotate(90,26,26)"
              r="24.5"
              ...
              cx="26"
              strokeWidth="1.75"
              className="hourglass-loader__motion-medium"
            />
            <circle
              ...
              cx="26"
              strokeWidth="1"
              className="hourglass-loader__motion-thin"
            />
          </g>
          <g transform="translate(13.75,9.25)" className="hourglass-loader__model">
            ...
            <g strokeLinecap="round" stroke="hsl(35,90%,90%)">
              <line
                ...
                strokeWidth="1"
                className="hourglass-loader__sand-grain-left"
              />
              <line
                y2="21.75"
                x2="12.5"
                ...
                strokeDasharray="0.25 33.75"
                strokeWidth="1"
                className="hourglass-loader__sand-grain-right"
              />
              <line
                y2="31.5"
                x2="12.25"
                ...
                strokeWidth="1"
                className="hourglass-loader__sand-drop"
              />
              <line
                y2="31.5"
                x2="12.25"
                ...
                strokeWidth="1.5"
                className="hourglass-loader__sand-fill"
              />
              <line
                y2="31.5"
                x2="12"
                ...
                strokeWidth="1"
                stroke="hsl(35,90%,83%)"
                className="hourglass-loader__sand-line-left"
              />
              <line
                y2="31.5"
                x2="12.5"
                ...
                strokeWidth="1"
                stroke="hsl(35,90%,83%)"
                className="hourglass-loader__sand-line-right"
              />
            ...
            <rect height="2" width="24.5" fill="hsl(var(--primary))" />
            <rect
              height="1"
              width="19.5"
              y="0.5"
      ...
      <style>{`
        ...
        .hourglass-loader__glare-top {
          animation-name: hourglass-glare-top;
        }
        .hourglass-loader__glare-bottom {
          animation-name: hourglass-glare-bottom;
        }
        .hourglass-loader__model {
          animation-name: hourglass-loader-flip;
        ...
        .hourglass-loader__motion-thick {
          animation-name: hourglass-motion-thick;
        }
        .hourglass-loader__motion-medium {
          animation-name: hourglass-motion-medium;
        }
        .hourglass-loader__motion-thin {
          animation-name: hourglass-motion-thin;
        }
        .hourglass-loader__sand-drop {
          animation-name: hourglass-sand-drop;
        }
        .hourglass-loader__sand-fill {
          animation-name: hourglass-sand-fill;
        }
        .hourglass-loader__sand-grain-left {
          animation-name: hourglass-sand-grain-left;
        }
        .hourglass-loader__sand-grain-right {
          animation-name: hourglass-sand-grain-right;
        }
        .hourglass-loader__sand-line-left {
          animation-name: hourglass-sand-line-left;
        }
        .hourglass-loader__sand-line-right {
          animation-name: hourglass-sand-line-right;
        }

        @keyframes hourglass-loader-flip {
          from {
