...
interface HamsterWheelIconProps {
  className?: string;
}

export function HamsterWheelIcon({ className }: HamsterWheelIconProps) {
  return (
    <div 
      ...
      style={{ 
        width: '16px', 
        height: '16px',
        fontSize: '1px' // Base font size for scaling
      }}
    >
      <div 
        ...
        style={{
          ...
          width: '12em',
          height: '12em',
          fontSize: '1.33px' // Scaled to fit 16px container
